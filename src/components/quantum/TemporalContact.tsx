...
export default function TemporalContact() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 p-8 min-h-screen flex items-center">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Contact Form */}
            <motion.div
              className="relative p-8 bg-black/50 border border-gray-600/50 rounded-lg backdrop-blur-md"
            ...
            >
              <div className="relative p-8 bg-black/50 border border-gray-600/50 rounded-lg backdrop-blur-md">
                <h3 className="text-2xl font-mono text-purple-400 mb-6">
                  Get In Touch
                </h3>
